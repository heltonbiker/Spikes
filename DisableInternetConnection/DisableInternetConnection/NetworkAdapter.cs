namespace ROOT.CIMV2.Win32
{
    ...
    // As funções ShouldSerialize<PropertyName> são usadas pelo pesquisador de propriedades do VS para verificar se uma determinada propriedade precisa ser serializada. Essas funções são adicionadas a todas as propriedades ValueType (dos tipos Int32 e BOOL, entre outros, que não podem ser definidos como nulos). Elas usam a função Is<PropertyName>Null. Elas também são usadas na implementação de TypeConverter para que as propriedades verifiquem se há valores de propriedade NULL, a fim de que um valor em branco seja mostrado no pesquisador de propriedades caso seja necessário efetuar uma operação de arrastar e soltar no Visual Studio.
    // Funções Is<PropertyName>Null() são usadas para verificar se uma propriedade é NULL.
    // As funções Reset<PropertyName> são adicionadas às propriedades Nullable Read/Write. Essas funções são usadas pelo designer do VS no pesquisador de propriedades para definir uma propriedade como NULL.
    // Cada propriedade adicionada à classe da propriedade WMI possui um conjunto de atributos para definir seu comportamento no designer do Visual Studio e para definir um TypeConverter a ser usado.
    // As funções de conversão ToDateTime e ToDmtfDateTime são adicionadas à classe para converter data/hora DMTF em System.DateTime e vice-versa.
    // Classe Early Bound gerada para a classe WMI.Win32_NetworkAdapter
    public class NetworkAdapter : System.ComponentModel.Component
    {

        // Propriedade particular para armazenar o espaço para nome WMI no qual a classe reside.
        private static string CreatedWmiNamespace = "root\\CimV2";

        // Propriedade particular para armazenar o nome da classe WMI que criou esta classe.
        private static string CreatedClassName = "Win32_NetworkAdapter";

        // Variável de membro particular para manter o ManagementScope usado pelos diversos métodos.
        ...
        // Variável particular para armazenar a propriedade incorporada que representa a instância.
        private System.Management.ManagementBaseObject embeddedObj;

        // Objeto WMI atual usado
        private System.Management.ManagementBaseObject curObj;

        // Sinalizador para indicar se a instância é um objeto incorporado.
        private bool isEmbedded;

        // A seguir são apresentadas diferentes sobrecargas de construtores para inicializar uma instância da classe com um objeto WMI.
        ...
        // A propriedade retorna o espaço para nome da classe WMI.
        [Browsable(true)]
        ...
        // Propriedade que aponta para um objeto incorporado para obter as propriedades System do objeto WMI.
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        // Propriedade retornando o objeto lateBound subjacente.
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        // Propriedade pública de escopo static usada pelos diversos métodos.
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
...
.. - Other - For integer values other than those listed above, refer to Win32 error code documentation.")]
        ...
        // Sobrecargas diferentes de GetInstances() ajudam na enumeração de instâncias da classe WMI.
        ...
        // Classe incorporada para representar as propriedades do sistema WMI.
